...
out_dir <- file.path(base_dir, "3_Consensus_DGE_analysis/3_1_Core_signature")
...
###Annote list ###
annot_universe <- readRDS("~/Ovary_signatures/3_Consensus_DGE_analysis/3_0_Counts_metadata/3_3_2_gene_annotation_UNION_universe.rds")
