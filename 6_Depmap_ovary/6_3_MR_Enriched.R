...
all_regulones <- readRDS("/STORAGE/csbig/jruiz/Ovary_data/6_MRA/cancer_ovary_regulon_300bt_p1e-8.rds")
regulons_filtered <- all_regulones[names(all_regulones) %in% names_all_regulones$TF]
length(names(regulons_filtered)) #[1] 1174
saveRDS(names(regulons_filtered), file = "~/Ovary_signatures/6_Depmap_ovary/6_3_regulons_all.rds")


##Get significant regulones (from NES elbow analysis, top)#####
regulons <- readRDS("/STORAGE/csbig/jruiz/Ovary_data/6_MRA/6_0_Top_elbow_regulones.rds")
regulons_names <- names(regulons) #328
saveRDS(regulons_names, file = "~/Ovary_signatures/6_Depmap_ovary/6_3_regulons_names_topNES.rds")

#Get DF of DEGs with high dependency
df <- vroom("~/Ovary_signatures/6_Depmap_ovary/6_2_0_Dependency_DEG_core.tsv",
...
saveRDS(TF_DGE_DepMap, file = "~/Ovary_signatures/6_Depmap_ovary/6_3_1_names_TF_DEG_TopNES.rds")
...
saveRDS(
  ...
  file = "~/Ovary_signatures/6_Depmap_ovary/6_4_regulons_sig_filtered.rds")
...
# Guardar si quieres
saveRDS(all_genes,
        "~/Ovary_signatures/6_Depmap_ovary/6_5_Important_regulones_1.rds")

# ============================================================
# 9) Save figure (high resolution, vertical layout)
# ============================================================

out_path <- "~/Ovary_signatures/6_Depmap_ovary/6_2_4_Enriched_TF_Depndency"
