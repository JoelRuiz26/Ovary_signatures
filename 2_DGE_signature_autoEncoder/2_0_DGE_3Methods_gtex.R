...
saveRDS(
  meta_all,
  "2_1_Output_gtex_rds/2_2_Meta_DE_OVARY_ALL_Stouffer.rds"
)
...
saveRDS(
  meta_sig,
  "2_1_Output_gtex_rds/2_2_Meta_DE_OVARY_significant_Stouffer.rds"
)


save.image("/STORAGE/csbig/jruiz/Ovary_data/2_Output_AutoEncoder/Image_DiseaseSignature_OVARY.RData")
