...
saveRDS(
  meta_all,
  "2_1_Output_adjacent_rds/2_2_Meta_DE_OVARY_ALL_RobustRankAggreg_directional.rds"
)
...
saveRDS(
  meta_sig,
  "2_1_Output_adjacent_rds/2_2_Meta_DE_OVARY_significant_RobustRankAggreg_directional.rds"
)
